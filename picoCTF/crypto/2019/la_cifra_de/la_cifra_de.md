...
```bash
hone@unidad03:~$ nc jupiter.challenges.picoctf.org 5726
Encrypted message:
...
Se utilizar un desencriptador Vigenère, y se obtiene el texto desencriptado.
...
Donde se puede observar la llave
