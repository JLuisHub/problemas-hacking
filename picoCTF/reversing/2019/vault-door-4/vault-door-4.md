...
```bash
hone@unidad03:~/vault-door-4$ cat VaultDoor4.java
```
...
Se cambian las siguientes lineas para crear el siguiente programa:
...
byte[] myBytes = {
        ...
        String llave = new String(myBytes);
        System.out.println(llave);
```

Se corre el programa para poder observar la llave y mostrar.

```
Enter vault password: picoCTF{algo}
